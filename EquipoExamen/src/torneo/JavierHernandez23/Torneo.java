...
/**
 * En esta clase se crean torneos, creando los partidos, comprobando si existen, etc.
 * 
 * @author javier.hernandez23
 * @version 1.5
 * @since 1.0
 */
public class Torneo {
...
/**
 * Agrega partidos comprobando que los datos de entrada sean correctos
 * @param nuevo
 * @return boolean
